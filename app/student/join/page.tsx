...
export default function StudentJoinPage() {
  ...
  useEffect(() => {
    ...
    if (trimmed.length !== 8) {
      deferStateUpdate(() => setFoundRoom(null));
      deferStateUpdate(() => setError(undefined));
      return;
    }
    
    deferStateUpdate(() => setSearching(true));
            ...
            {searching ? (
              ...
              <div className="rounded-xl border-2 border-(--border) bg-white p-4 shadow-[3px_3px_0_#1a1a1a]">
                ...
                {!statusInfo.canJoin ? (
                  ...
                  <div
                    className="mt-3 rounded-lg bg-(--primary-surface) px-3 py-2 text-xs font-semibold text-emerald-800">
