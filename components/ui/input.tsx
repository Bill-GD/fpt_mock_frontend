  ...
  return (
    <label className="grid gap-1.5 text-sm">
      ...
      <input
        id={inputId}
        className={[
          "h-9 w-full rounded-xl border-2 border-(--border) bg-white px-3 text-sm text-zinc-900 shadow-[2px_2px_0_#1a1a1a] outline-none transition-all",
          "placeholder:text-zinc-400 focus:shadow-[1px_1px_0_#1a1a1a] focus:ring-2 focus:ring-(--primary)/20",
